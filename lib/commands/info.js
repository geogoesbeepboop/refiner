...
class Info extends core_1.Command {
    async run() {
        ...
        this.log(chalk_1.default.gray(`   OpenAI API Key: ${config_1.config.getApiKey() ? 'set' : 'not set'}`));
        this.log(chalk_1.default.gray(`   Claude API Key: ${config_1.config.getClaudeApiKey() ? 'set' : 'not set'}`));
        this.log(chalk_1.default.gray(`   Gemini API Key: ${config_1.config.getGeminiApiKey() ? 'set' : 'not set'}`));
