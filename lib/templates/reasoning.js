...
exports.REASONING_ANALYSIS_PROMPT = exports.REASONING_COMPACT_ANALYSIS_PROMPT = exports.REASONING_DETAILED_ANALYSIS_PROMPT = void 0;
exports.buildReasoningTemplate = buildReasoningTemplate;
function buildReasoningTemplate(data, format, flavor = 'detailed') {
    if (flavor === 'compact') {
        return buildReasoningCompactMarkdown(data);
    }
    if (format === 'json') {
...
function buildReasoningJSON(data) {
    ...
    if (isDetailed) {
        return buildReasoningDetailedJSON(data);
    }
    else {
        return buildReasoningCompactJSON(data);
    }
}
function buildReasoningDetailedJSON(data) {
    const jsonStructure = {
...
function buildReasoningCompactJSON(data) {
    const jsonStructure = {
...
function buildReasoningCompactMarkdown(data) {
...
exports.REASONING_DETAILED_ANALYSIS_PROMPT = `You are an expert AI prompt engineer. Your task is to analyze an unstructured prompt and transform it into a comprehensive, well-structured reasoning prompt optimized for AI model-to-model communication for building features and products.
...
exports.REASONING_COMPACT_ANALYSIS_PROMPT = `You are an expert AI prompt engineer. Your task is to analyze an unstructured prompt and transform it into a focused, compact reasoning prompt optimized for quick, structured AI model-to-model problem-solving communication.
...
exports.REASONING_ANALYSIS_PROMPT = exports.REASONING_DETAILED_ANALYSIS_PROMPT;
