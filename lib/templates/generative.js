...
exports.GENERATIVE_ANALYSIS_PROMPT = void 0;
exports.buildGenerativeTemplate = buildGenerativeTemplate;
function buildGenerativeTemplate(data, format) {
    if (format === 'json') {
...
exports.GENERATIVE_ANALYSIS_PROMPT = `You are an expert AI prompt engineer. Your task is to analyze an unstructured prompt and transform it into a comprehensive, well-structured generative prompt optimized for AI model-to-model communication for building features and products.
